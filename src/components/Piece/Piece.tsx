...
const King = ({ color }: PieceSvgProps) => (
    <svg viewBox="0 0 45 45" fill={color}>
      <path d="M 22.5,11.63 L 22.5,6" stroke="#000" strokeWidth="2.5" strokeLinejoin="miter"/>
      <path d="M 20,8 L 25,8" stroke="#000" strokeWidth="2.5" strokeLinejoin="miter"/>
      <path d="M 22.5,25 L 22.5,30" strokeLinecap="butt" stroke="#000"/>
      <path d="M 12.5,37 C 12.5,40 20,42 22.5,42 C 25,42 32.5,40 32.5,37" strokeLinecap="butt" stroke="#000"/>
      <path d="M 12.5,30 C 12.5,33.5 20,34.5 22.5,34.5 C 25,34.5 32.5,33.5 32.5,30" strokeLinecap="butt" stroke="#000"/>
      <path d="M 12.5,33.5 L 32.5,33.5" strokeLinecap="butt" stroke="#000"/>
      <path d="M 12.5,37 L 32.5,37" strokeLinecap="butt" stroke="#000"/>
      <path d="M 22.5,30 C 25,29 27.5,28 30,25 C 30,22.5 22.5,22.5 22.5,22.5 C 22.5,22.5 15,22.5 15,25 C 17.5,28 20,29 22.5,30" strokeLinecap="butt" stroke="#000"/>
      ...
      <path d="M 14,35.5 L 31,35.5" strokeLinecap="butt" strokeWidth="1" stroke="#000"/>
      <path d="M 14,14 L 31,14" strokeLinecap="butt" strokeWidth="1" stroke="#000"/>
    </svg>
  );
  ...
  const Queen = ({ color }: PieceSvgProps) => (
    <svg viewBox="0 0 45 45" fill={color}>
      <g strokeWidth="1.5" strokeLinecap="round">
        ...
        <path d="M 9,26 C 17.5,24.5 27.5,24.5 36,26 L 31,17 L 14,17 L 9,26" strokeLinecap="butt"/>
  ...
  const Knight = ({ color }: PieceSvgProps) => (
    <svg viewBox="0 0 45 45" fill={color}>
      <g strokeWidth="1.5" strokeLinecap="round">
        ...
        <path d="M 32,16 C 32,16 32,16.5 31,17 C 31.031,17.406 29.672,19.672 28,21 C 27.5,21.5 27,22 27,22" strokeLinejoin="miter"/>
        <path d="M 27,22 C 27,22 26,22.5 25,21 C 24,19.5 23.5,18.5 22,18 L 21,19 L 20,19" strokeLinejoin="miter"/>
        <path d="M 20,19 C 20,19 14,20.5 14,26 C 14,26 14,29.5 14,29.5 C 14,29.5 13.5,30 14,32" strokeLinejoin="miter"/>
        <path d="M 14,32 L 19,32" strokeLinejoin="miter"/>
        <path d="M 19,32 C 19,32 19.937,31.688 21,30 C 22.063,28.312 22,27 22,27" strokeLinejoin="miter"/>
        <path d="M 22,27 L 24,24 L 23,19" strokeLinejoin="miter"/>
        <path d="M 24,24 L 28,24" strokeLinejoin="miter"/>
        <path d="M 24,19 C 24,19 24,18.5 23,18 C 23,18 23,17.5 22,17 C 22,17 20,16 20,16" strokeLinejoin="miter"/>
        <path d="M 20,16 C 20,16 18,16.5 16,18 C 15.406,18.281 14.406,18.406 13.5,18.5" strokeLinejoin="miter"/>
        <path d="M 13.5,18.5 L 14,20 C 14,20 14,21.5 14.5,21 C 15,20.5 16,19 16,19" strokeLinejoin="miter"/>
        ...
        <path d="M 9,36 C 12,32 16,29 22.5,29" strokeLinecap="butt" strokeLinejoin="miter"/>
        <path d="M 22.5,29 C 29,29 33,32 36,36" strokeLinecap="butt" strokeLinejoin="miter"/>
