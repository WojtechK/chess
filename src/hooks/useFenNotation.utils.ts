import { COLUMNS } from "../components/Board/Board.types";
...
export const getNewFenData = (
  ...
  /**
   * Helper function to toggle between pieces of same color
   */
  export const getNewToggledSelectedSquare = (
    fenData: FenData,
    selectedSquare: string,
    row: RowsType,
    colIndex: number
